...
/*
*   Taken from: https://github.com/nikini/ionic-gallery-modal/blob/master/src/zoomable-image/zoomable-image.ts
*   It's ugly and does not follow angular's style guide, but it does the job... 
*
*   Thank you, GitHub!
*/
...
export class ZoomableImageComponent implements OnInit, OnDestroy {
